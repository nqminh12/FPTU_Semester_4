...
import dal.EventDBContext;
import dal.RecordDBContext;
...
public class ReportController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Event> events = edb.getAllEvent();
        RecordDBContext rdb = new RecordDBContext();
        ArrayList<Record> reports = rdb.getAllRecord();
