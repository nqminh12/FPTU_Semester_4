...
public class Add extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        DAO dao = new DAO();
        List<Certificate> cert = dao.findAllCertificate();
    ...
    throws ServletException, IOException {
        ...
        dao.insertEmployee(id, name, dob, gender, createby);
        String[] certid = request.getParameterValues("certid");
        String[] date = request.getParameterValues("date");
        for (int i = 0; i < certid.length; i++) {
            dao.insertCertificate(Integer.parseInt(id), certid[i], date[i]);
        }
