        ...
        if(ses.getAttribute("user") != null){
            ...
            if(u.getRoll() == 0) chain.doFilter(request, response);
                ...
                if(url.contains("Admin")){
                    res.sendRedirect(req.getContextPath()+"/Member/Mem1");
                }else{
                    chain.doFilter(request, response);
                }
            }else if(u.getRoll()==2){
                if(url.contains("Admin") || url.contains("Member")){
                    res.sendRedirect(req.getContextPath()+"/Other/Other");
                }else{
                    chain.doFilter(request, response);
                }
            }else{
                if(url.contains("Admin") || url.contains("Member") || url.contains("Other")){
            ...
            if(url.contains("Login")) chain.doFilter(request, response);
            else
