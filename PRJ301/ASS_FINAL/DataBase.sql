create database ASS_FINAL
drop database ASS_FINAL
CREATE TABLE Users (
...
Update Products set category_id = 5 where product_id = 31
DELETE FROM Products;

INSERT INTO Users (username, password, email, full_name, phone_number, isAdmin) 
VALUES
...
select * from Users where username = 'nguyenvana' and password ='123456'

INSERT INTO Addresses (user_id, city, state, country)
VALUES
...
INSERT INTO Users (username, password, email, full_name, phone_number, isAdmin) 
VALUES('nguyenquangminh','121003','minhnqhe176167@fpt.edu.vn','Nguyen quang minh','0943081570',0)
